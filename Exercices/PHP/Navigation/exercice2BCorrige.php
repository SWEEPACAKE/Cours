...
$utilisateur = $tableau[$_GET['id_utilisateur']];

// echo $tableau[$_GET['id_utilisateur']]['pseudonyme'] . " " . $tableau[$_GET['id_utilisateur']]['email'];
echo $utilisateur['pseudonyme'] . " " . $utilisateur['email'];