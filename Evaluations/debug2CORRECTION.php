...
$listeMorceaux = $database->execute_query("SELECT a.libelle as artiste, m.titre, m.duree_en_secondes
FROM morceau m 
            ...
            <div class="col-12 col-md-6">
                ...
                foreach($listeMorceaux as $morceau) {
                    ...
                    <div class="artiste my-3">
                        <?= $morceau['artiste'] ?> - <?= $morceau['titre'] ?> : <?= FORMAT_TIME($morceau['duree_en_secondes']) ?>
                    </div>
                    <?php
                }
                ?>
